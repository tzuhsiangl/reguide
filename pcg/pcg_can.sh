#!/bin/bash
# ReGuide test-time guidance (Phase-Conditioned Guidance) for the `can` task.
#
...
# ---- checkpoints + guidance targets (or set in dyn_model/conf/planner/eval_can.yaml) ----
...
TAU=10
THRESHOLD_PERC=80
GUIDANCE_THRESHOLD_LOWER_PERC=30
