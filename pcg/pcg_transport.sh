#!/bin/bash
# ReGuide test-time guidance (Phase-Conditioned Guidance) for the `transport` task.
#
#   conda activate reguide
#   bash pcg/pcg_transport.sh
#
...
# ---- checkpoints + guidance targets (or set in dyn_model/conf/planner/eval_transport.yaml) ----
